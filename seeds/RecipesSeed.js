...
const recipes = [
  {
    ...
    image:
      "https://images.immediate.co.uk/production/volatile/sites/30/2020/08/roast-chicken-roots-cc967f4.jpg?quality=90&webp=true&resize=300,272",
  },
  {
    ...
    image:
      "https://images.immediate.co.uk/production/volatile/sites/30/2020/08/tabouleh-dd2a8df.jpg?quality=90&webp=true&resize=300,272",
  },
  {
    ...
    image:
      "https://images.immediate.co.uk/production/volatile/sites/30/2020/08/meatball-kebabs-0c6bc11.jpg?quality=90&webp=true&resize=300,272",
  },

  {
    ...
    image:
      "https://images.immediate.co.uk/production/volatile/sites/30/2020/08/ginger-cookie-sandwiches-with-lemon-mascarpone_0-5a57429.jpg?quality=90&webp=true&resize=300,272",
  },

  {
    ...
    image:
      "https://images.immediate.co.uk/production/volatile/sites/30/2020/08/vanilla-lemongrass-creme-brulee-2f78be5.jpg?quality=90&webp=true&resize=300,272",
  },

  {
    ...
    image:
      "https://images.immediate.co.uk/production/volatile/sites/30/2020/08/coconut-cupcakes-71c7fed.jpg?quality=90&webp=true&resize=300,272",
  },
...

  {
    ...
    image:
      "https://images.immediate.co.uk/production/volatile/sites/30/2020/08/two-minute-breakfast-smoothie-4a4722d.jpg?quality=90&webp=true&resize=300,272",
  },

  {
    ...
    image:
      "https://images.immediate.co.uk/production/volatile/sites/30/2020/08/recipe-image-legacy-id-1081496_11-dde2a76.jpg?quality=90&webp=true&resize=300,272",
  },
];
...
mongoose
  ...
  .then(() => {
    recipeModel
      ...
      .then((createdRecipes) => {
        console.log(
          `seed recipes done : ${createdRecipes.length} documents inserted !`
        );
      })
      .catch((error) => {
        console.log(error);
